...
- Le code de l'application dérivé de Blender reste sous la licence publique générale GNU (GPL), version 3, avec des fichiers individuels utilisant parfois une licence différente mais compatible.
