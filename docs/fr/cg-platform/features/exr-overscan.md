...
- [RNA Properties (API Reference)](/fr/cg-platform/api/rna-properties) — Les propriétés de l'API Python pour configurer l'overscan par script.
- [Guide d'installation](/fr/cg-platform/guide/installation) — Détails sur l'isolation du cache de shaders OptiX.
