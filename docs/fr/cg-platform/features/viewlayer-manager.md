...
- [Opérateurs Python (API)](/fr/cg-platform/api/python-operators) — Référence de l'opérateur `wm.blender_vfx_viewlayer_manager_show`.
- [Passes par lobe de lightgroup](/fr/cg-platform/features/lightgroup-lobe-passes) — Les passes par lobe contrôlées par la section Cycles Light Pass AOVs.
