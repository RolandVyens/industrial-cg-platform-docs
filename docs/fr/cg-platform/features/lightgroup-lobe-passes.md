...
- [Système de passes et AOV (API)](/fr/cg-platform/api/pass-system) — Architecture interne d'enregistrement et de lecture des passes.
- [Extensions du noyau Cycles (API)](/fr/cg-platform/api/cycles-kernel) — Données d'index de division de lightgroup au niveau du noyau.
