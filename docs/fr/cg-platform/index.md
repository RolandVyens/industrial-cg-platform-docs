...
hero:
  ...
  actions:
    - theme: brand
      text: Premiers pas
      link: /fr/cg-platform/guide/getting-started
    - theme: alt
      text: Fonctionnalités
      link: /fr/cg-platform/features/deep-exr
    - theme: alt
      text: Référence API
      link: /fr/cg-platform/api/
...
features:
  ...
  - icon: 💡
    ...
    link: /fr/cg-platform/features/lightgroup-lobe-passes
  - icon: 🎨
    ...
    link: /fr/cg-platform/features/shadow-color
  - icon: 🖥️
    ...
    link: /fr/cg-platform/features/viewlayer-manager
---
