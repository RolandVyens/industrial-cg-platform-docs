...
| --- | --- |
| [Sortie Deep EXR](/fr/features/deep-exr) | Sortie de compositing profond native pour Cycles |
| [Passes par lobe de lightgroup](/fr/features/lightgroup-lobe-passes) | Passes divisées par lightgroup (diffus/glossy/transmission/volume) |
| [Couleur d'ombre](/fr/features/shadow-color) | Teinture artistique des ombres par lumière et par monde |
| [Gestionnaire de ViewLayer](/fr/features/viewlayer-manager) | Outil de gestion ViewLayer basé sur Qt avec préréglages |
...
- [Installation](/fr/guide/installation) — Télécharger et configurer la version.
- [Compilation depuis les sources](/fr/guide/building-from-source) — Compiler à partir du dépôt GitHub.
- [FAQ](/fr/guide/faq) — Questions fréquentes et réponses.
