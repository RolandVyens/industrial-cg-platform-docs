...
| --- | --- |
| [Deep EXR](/en/features/deep-exr) | Native deep compositing output for Cycles |
| [Lightgroup Lobe Passes](/en/features/lightgroup-lobe-passes) | Per-lightgroup diffuse/glossy/transmission/volume split passes |
| [Shadow Color](/en/features/shadow-color) | Per-light and per-world artistic shadow tinting |
| [ViewLayer Manager](/en/features/viewlayer-manager) | Qt-based ViewLayer management tool with presets |
...
- [Installation](/en/guide/installation) — Download and set up the release.
- [Building from Source](/en/guide/building-from-source) — Build from the GitHub repository.
