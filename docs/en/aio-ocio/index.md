...
*   Built on top of Genco Uney's acclaimed "PixelManager" OCIO config.
*   Full support for modern wide-gamut and scene-linear profiles (ACEScg, ACES2065-1, Rec.2020, sRGB Linear).
*   Built-in standard camera profiles (Arri LogC3/LogC4, RED Log3G10, Sony S-Log3) for seamless live-action plate integration.
