...
<a href="/screenshots/viewlayer-manager/manager-window.webp" target="_blank" rel="noopener"><img src="/screenshots/viewlayer-manager/manager-window.webp" alt="Industrial CG Platform ViewLayer Manager window with Beauty, Characters, and Environment view layers" loading="lazy"></a>
...
- [Python Operators (API)](/en/industrial-cg-platform/api/python-operators) — `wm.blender_vfx_viewlayer_manager_show` operator reference.
- [Lightgroup Lobe Passes](/en/industrial-cg-platform/features/lightgroup-lobe-passes) — The lobe passes controlled by the manager's Cycles Light Pass AOVs section.
