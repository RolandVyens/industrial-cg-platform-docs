...
1. [Usage & Guidelines](./usage) — Setting up light collections, constraints, and testing.
2. [Nuke Auto-Shuffle Integration](./nuke-setup) — Setting up the companion script inside Nuke.
