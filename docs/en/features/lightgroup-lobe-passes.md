...
- [Pass & AOV System (API)](/en/api/pass-system) — Internal pass registration and readback architecture.
- [Cycles Kernel Extensions (API)](/en/api/cycles-kernel) — Kernel-level lightgroup split index data.
