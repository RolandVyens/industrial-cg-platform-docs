...
- [Python Operators (API)](/en/api/python-operators) — `wm.blender_vfx_viewlayer_manager_show` operator reference.
- [Lightgroup Lobe Passes](/en/features/lightgroup-lobe-passes) — The lobe passes controlled by the manager's Cycles Light Pass AOVs section.
