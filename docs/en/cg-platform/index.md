...
hero:
  ...
  actions:
    - theme: brand
      ...
      link: /en/cg-platform/guide/getting-started
    - theme: alt
      text: Features
      link: /en/cg-platform/features/deep-exr
    - theme: alt
      text: API Reference
      link: /en/cg-platform/api/
...
features:
  ...
  - icon: 🖥️
    ...
    link: /en/cg-platform/features/viewlayer-manager
---
