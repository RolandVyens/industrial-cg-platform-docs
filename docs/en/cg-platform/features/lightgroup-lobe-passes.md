...
- [Pass & AOV System (API)](/en/cg-platform/api/pass-system) — Internal pass registration and readback architecture.
- [Cycles Kernel Extensions (API)](/en/cg-platform/api/cycles-kernel) — Kernel-level lightgroup split index data.
