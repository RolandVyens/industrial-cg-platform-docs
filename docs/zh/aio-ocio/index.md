...
### 🎬 专业电影级色彩空间
*   基于 Genco Uney 著名的 “PixelManager” OCIO 配置进行二次优化。
*   全面支持现代宽色域和场景线性配置文件（ACEScg、ACES2065-1、Rec.2020、sRGB Linear）。
*   内置主流电影摄像机曲线（Arri LogC3/LogC4、RED Log3G10、Sony S-Log3），便于无缝拼合实拍素材。
